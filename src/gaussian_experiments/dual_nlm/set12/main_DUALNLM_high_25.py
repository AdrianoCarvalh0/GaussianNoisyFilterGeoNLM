...
if __name__ == '__main__':
    ...
    root_dir_output_high_25 = Path('/workspace/data/output/set12/high_noisy_25') 
    ...
    parameters = {
        ...
        'pickle_results_summary_high_25': '/workspace/data/output/set12/high_noisy_25/results/array_nln_high_filtereds.pkl',
