...
if __name__ == '__main__':
    ...
    root_dir_output_high_50 = Path('/workspace/data/output/set12/high_noisy_50') 
    ...
    parameters = {
        ...
        'pickle_results_summary_high_50': '/workspace/data/output/set12/high_noisy_50/results/array_nln_high_filtereds.pkl',
