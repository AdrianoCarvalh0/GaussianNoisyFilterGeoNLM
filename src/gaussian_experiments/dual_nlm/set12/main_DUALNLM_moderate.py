...
if __name__ == '__main__':
    ...
    root_dir_output_moderate = Path('/workspace/data/output/set12/moderate_noisy') 
    ...
    parameters = {
        ...
        'pickle_results_summary_moderate': '/workspace/data/output/set12/moderate_noisy/results/array_nln_moderate_filtereds.pkl',
