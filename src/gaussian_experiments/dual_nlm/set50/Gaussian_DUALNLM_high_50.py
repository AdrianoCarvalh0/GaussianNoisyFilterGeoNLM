...
def generate_gaussian_experiment_high_50_dual_nlm(parameters):
    """
    Run the high_50-noise Gaussian denoising experiment using NLM, GEO-NLM, and BM3D.
    ...
    save_results_to_xlsx(       
        dir_out_results,
        name_results_xlsx_dual_nlm_output_high_50
    )
