...
if __name__ == '__main__':
    ...
    root_dir_output_high = Path('/workspace/data/output/set50/high_noisy') 
    ...
    parameters = {
        ...
        'pickle_results_summary_high': '/workspace/data/output/set50/high_noisy/results/array_nln_high_filtereds.pkl',
        'pickle_results_cameraman': '/workspace/data/output/set50/high_noisy/results/array_nln_high_filtereds_cameraman.pkl',
