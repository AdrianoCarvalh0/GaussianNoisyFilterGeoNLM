...
from Gaussian_DUALNLM_low import generate_gaussian_experiment_low_dual_nlm
...
if __name__ == '__main__':
    ...
    root_dir_output_low = Path('/workspace/data/output/set50/low_noisy') 
    ...
    parameters = {
        ...
        'pickle_results_summary_low': '/workspace/data/output/set50/low_noisy/results/array_nln_low_filtereds.pkl',
        'pickle_results_cameraman': '/workspace/data/output/set50/low_noisy/results/array_nln_low_filtereds_cameraman.pkl',
