...
from Gaussian_DUALNLM_moderate import generate_gaussian_experiment_moderate_dual_nlm
...
if __name__ == '__main__':
    ...
    root_dir_output_moderate = Path('/workspace/data/output/set50/moderate_noisy') 
    ...
    parameters = {
        ...
        'dir_out_dualnlm': str(root_dir_output_moderate / 'DUALNLM'),
        'dir_out_results': str(root_dir_output_moderate / 'results'),

        # Filenames for serialized results (pickle/XLSX)
        'name_pickle_dual_nlm_output_moderate': 'array_dual_nlm_moderate_filtereds.pkl',    
        'name_results_xlsx_dual_nlm_output_moderate':'dual_nlm_moderate_filtereds.xlsx',
        'pickle_results_summary_moderate': '/workspace/data/output/set50/moderate_noisy/results/array_nln_moderate_filtereds.pkl',
        'pickle_results_cameraman': '/workspace/data/output/set50/moderate_noisy/results/array_nln_moderate_filtereds_cameraman.pkl',
    ...
    generate_gaussian_experiment_moderate_dual_nlm(parameters)
