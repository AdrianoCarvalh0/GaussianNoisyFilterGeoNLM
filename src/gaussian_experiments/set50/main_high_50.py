...
if __name__ == '__main__':
    ...
    root_dir_output_high_50 = f'/workspace/data/output/set50/high_noisy_50/test'
    ...
    parameters = {
        ...
        'root_dir_output_high': root_dir_output_high_50,
        'dir_images_general': dir_images_general,

        # Output folders for each filtering method
        'dir_out_nlm': f'{root_dir_output_high_50}/NLM',
        'dir_out_geonlm': f'{root_dir_output_high_50}/GEONLM',
        'dir_out_bm3d': f'{root_dir_output_high_50}/BM3D',
        'dir_out_results': f'{root_dir_output_high_50}/results',
